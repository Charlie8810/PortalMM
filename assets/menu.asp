...
<div class="logo"><h1><a href="#"><img src="./images/logo_chico.png" /></a></h1></div>
  <ul>
    ...
    <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>Clientes</span></a>
		<ul>
			...
			<li><a href="#">Publica tus Máquinas</a></li>
			<li><a href="#">Revisa tu Plan</a></li>
			<li><a href="#">Revisa tus Pagos</a></li>
      </ul>
	</li>
	...
	<li><a href="#"><i class="icon icon-fullscreen"></i> <span>Informes</span></a></li>
