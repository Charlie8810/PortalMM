...
<div id="messageDiv" class="col-md-12" style="display: none;">
  ...
  <h1>Mantenedor de Publicidad Principal</h1>
</div>
<%if request.QueryString("opc")= "sav" then 
	...
	<script type="text/javascript">
		...
		window.location="demo_tabla.asp?msg=1";
	</script>
	<%
end if
   ...
   <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="form-actions">
            <button type="button" class="btn btn-success" onClick="javascript:irA(document.forms.form2_crit,'demo_tabla.asp?opc=idmaq2');">Editar</button>
            <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form2_crit,'demo_tabla.asp?opc=idmaq');">Eliminar</button>
