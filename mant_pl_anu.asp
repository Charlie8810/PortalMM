...
<div id="content-header">
  ...
  <h1>Mantenedor de Planes Anuales</h1>
</div>
<%if request.QueryString("opc")= "sav" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_anu.asp?msg=1";
	</script>
	<%
end if
if request.QueryString("opc")= "sav2" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_anu.asp?msg=2";
	</script>
	<%
end if
if request.QueryString("opc")= "del" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_anu.asp?msg=3";
	</script>
	<%
end if
%>
<%if request.QueryString("opc")= "idmaq" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_anu.asp?msg=4";
	</script>
	<%
	else
		if len(var_chk_sel) > 0 then
				Response.Redirect("mant_pl_anu.asp?opc=edit&id="& var_chk_sel)
				Response.End
		end if
	end if
end if
    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon border-blue"> <i class="icon-align-justify"></i> </span>
          <h5>Mantenedor de Planes Anuales</h5>
        </div>
        <div class="widget-content nopadding">
          <form name="form1_crit" action="#" method="post" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'mant_pl_anu.asp?opc=sch');">Buscar</button>
			  <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'mant_pl_anu.asp?opc=new');">Nuevo</button>
            </div>
			<br>
          </form>
        </div>
   ...
   <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="form-actions">
            <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form2_crit,'mant_pl_anu.asp?opc=idmaq');">Editar</button>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
           <form name="form3_crit" method="post" class="form-horizontal">
			...
			<br>
			<div class="form-actions">
				<button type="submit" class="btn btn-success" onClick="javascript:validarDatos(document.forms.form3_crit,'mant_pl_anu.asp?opc=sav');">Guardar</button>
				<button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form3_crit,'mant_pl_anu.asp?opc=del');">Eliminar</button>
			</div>
			<br>
          </form>
        </div>
			  ...
			  <div class="widget-box">
				...
				<div class="widget-content nopadding">
				   <form name="form4_crit" method="post" class="form-horizontal">
					...
					<br>
					<div class="form-actions">
						<button type="submit" class="btn btn-success" onClick="javascript:validarDatos(document.forms.form4_crit,'mant_pl_anu.asp?opc=sav2');">Guardar</button>
					</div>
					<br>
				  </form>
				</div>
