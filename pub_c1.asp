    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon border-blue"> <i class="icon-align-justify"></i> </span>
          <h5>Mantenedor de Publicidad Cuadro 1</h5>
        </div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
           <form name="form3_crit" method="post" class="form-horizontal">
			...
			<div class="form-actions">
				<button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form3_crit,'pub_c1.asp?opc=sav2');">Guardar</button>
			</div>
          </form>
        </div>
      </div>
