...
<head>
       ...
       <!-- <link rel="shortcut icon" href="assets2/images/favicon_1.ico">
        ...
        <link href="assets2/css/core.css" rel="stylesheet" type="text/css" />
        <link href="assets2/css/components.css" rel="stylesheet" type="text/css" />
        <link href="assets2/css/icons.css" rel="stylesheet" type="text/css" />
        <link href="assets2/css/pages.css" rel="stylesheet" type="text/css" />
...
<body>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
									<h4 class="text-dark header-title m-t-0">Estadísticas de Planes</h4>
									<div class="text-center">
										<ul class="list-inline chart-detail-list">
											<li>
												<h5><i class="fa fa-circle m-r-5" style="color: #5fbeaa;"></i>Mensuales</h5>
											</li>
											<li>
												<h5><i class="fa fa-circle m-r-5" style="color: #5d9cec;"></i>Semestrales</h5>
											</li>
											<li>
												<h5><i class="fa fa-circle m-r-5" style="color: #dcdcdc;"></i>Anuales</h5>
											</li>
										</ul>
									</div>
...
<!-- Mirrored from coderthemes.com/ubold_1.1/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Nov 2015 02:13:00 GMT -->
</html>