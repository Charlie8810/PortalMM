					...
					<div class="row col-md-12">
						<div class="col-md-4">
							<div class="box special">
								...
								<br>
								<ul class="actions">
									<button type="button" class="button fit small" style="background:#F7931E" onClick="javascript:irA(document.forms.form_reg1,'Registro.asp?tip=1');">REVISAR</button>
								</ul>
								</form>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box special">
								...
								<ul class="actions">
									<button type="button" class="button fit small" style="background:#F7931E" onClick="javascript:irA(document.forms.form_reg2,'Registro.asp?tip=1');">REVISAR</button>
								</ul>
								</form>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box special">
								...
								<ul class="actions">
									<button type="button" class="button fit small" style="background:#F7931E" onClick="javascript:irA(document.forms.form_reg3,'Registro.asp?tip=1');">REVISAR</button>
								</ul>
								</form>
							</div>
						</div>
   ...
   <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          <div id="planes" class="widget-title"> <span class="icon border-blue"><i class="icon-th"></i></span>
            ...
            <table class="table table-bordered table-striped with-check">
              <thead>
                <tr>
                  ...
                  <th>Cantidad de<br>Equipos</th>
				  <th>Cantidad de<br>Regiones</th>
                  <th>Acceso Portal<br>Clientes</th>
                  <th>Descuento en<br>Publicidad</th>
                  <th>Valor</th>
                  <th>Opcion</th>
                </tr>
              </thead>
			  ...
			  <%
				...
				sql="exec MantenedorPlanes 1 , -1 , -1, '' , 0 ,'','','','',0, 0, 0 "
					set rs = nothing
					Set rs = cn.Execute(sql)
					...
					'	vCliPlan 	= rs("id_cliente_plan")
						...
						vDescTipo	= rs("nombre")
					'	vEquipo		= rs("equipo")
						vDesc1		= rs("num_Equipo")
						vDesc2 		= rs("num_Region")
						vDesc3		= rs("desc3")
						vDesc4		= rs("desc4")
						vValor		= rs("valor")
					'	vOperador	= rs("operador")
					...
					'	vTraslado	= rs("traslado")
						...
						<tr class="gradeX">
						  ...
						  <th><%=vDesc4%></th>
						  <th><%=vValor%></th>
						  <th><button type="submit" class="button fit small" onClick="javascript:irA(document.forms.form2_crit,'pub_maq.asp?opc=idmaq');">Contratar</button></th>
