...
<div id="content-header">
  ...
  <h1>Mantenedor de Clientes - Publica tus Equipos</h1>
</div>
<%if request.QueryString("opc")= "sav" then
	...
	<script type="text/javascript">
		...
		window.location="pub_maq.asp?msg=2";
	</script>
	<%
	end if
end if
if request.QueryString("opc")= "sav2" then
	...
	if not rs.eof then
		...
		%>
		<script type="text/javascript">
			window.location="pub_maq.asp?msg=6";
		</script>
		<%
...
<%if request.QueryString("opc")= "idmaq" then
	...
	<script type="text/javascript">
		...
		window.location="pub_maq.asp?msg=5";
	</script>
<%	else
		if len(var_chk_sel) > 0 then
				Response.Redirect("pub_maq.asp?opc=edit&id="& var_chk_sel)
				Response.End
		end if
	end if
end if
...
if request.QueryString("opc")= "idmaq3" then 
	...
	<script type="text/javascript">
		...
		setTimeout(window.location="pub_maq.asp";, 3000);
	</script>
<%	else
		if len(var_chk_sel) > 0 then
				Response.Redirect("pub_maq.asp?opc=edit2&id="& var_chk_sel)
				Response.End
		end if	
	end if
end if 
...
<div class="widget-content nopadding">
          <form name="form1_crit" action="#" method="post" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="button" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'pub_maq.asp?opc=sch');">Buscar</button>
			  <button type="button" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'pub_maq.asp?opc=new');">Nuevo</button>
			  <!--<button type="submit" class="btn btn-success" onClick="irAFuera(document.forms.form1_crit,'pub_maq.asp?opc=sch&exp=xls','_blank')">Exportar</button>-->
            </div>
          </form>
        </div>
  ...
  <div class="widget-box">
	...
	<div class="form-actions">
       <button type="button" class="btn btn-success" onClick="javascript:validarCambio(document.forms.form4_crit,'pub_maq.asp?opc=sav');">Guardar</button>
