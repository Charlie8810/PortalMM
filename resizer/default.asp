...
<html lang="en">
    ...
    <body>
        ...
        <p>Classic ASP script which uses a .NET Image resizer. JPG, PNG, GIF and BMP images are resized on the fly by the Resize_Image.aspx file using the following QueryString values:</p>
		<ul>
        ...
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=800&amp;IptFl=Input.jpg"/><br/>ImgWd=800&amp;IptFl=Input.jpg</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgHt=225&amp;IptFl=Input.jpg"/><br/>ImgHt=225&amp;IptFl=Input.jpg</div>
        <div style="clear:both"></div>

		<h2>Fixed Resize (Cropped / Padded / Coloured Padding)</h2>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg&amp;CrpYN=Y"/><br/>ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg&amp;CrpYN=Y</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg"/><br/>ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg&amp;PadCl=ff0000"/><br/>ImgWd=400&amp;ImgHt=400&amp;IptFl=Input.jpg&amp;PadCl=ff0000</div>
        <div style="clear:both"></div>

		<h2>Special Effects (Black &amp; White / Greyscale / Sepia)</h2>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=1"/><br/>ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=1</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=2"/><br/>ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=2</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=3"/><br/>ImgWd=300&amp;IptFl=Input.jpg&amp;SplEf=3</div>
        <div style="clear:both"></div>

		<h2>Output (Screen Only / Screen &amp; File / File Only)</h2>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=400&amp;IptFl=Input.jpg"/><br/>ImgWd=400&amp;IptFl=Input.jpg</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=300&amp;IptFl=Input.jpg&amp;OptFl=Thumb.jpg"/><br/>ImgWd=300&amp;IptFl=Input.jpg&amp;OptFl=Thumb.jpg</div>
        <div style="margin:20px;float:left"><img src="Resize_Image.aspx?ImgWd=1024&amp;IptFl=Input.jpg&amp;OptFl=Gallery.jpg&amp;OptSc=N" style="display:none"/><br/>ImgWd=1024&amp;IptFl=Input.jpg&amp;OptFl=Gallery.jpg&amp;OptSc=N</div>
        <div style="clear:both"></div>
