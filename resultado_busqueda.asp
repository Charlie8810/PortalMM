...
<script type="text/javascript">
    <%
    productos_Sql = "SELECT Id_DatosComunes, Descripcion, Nivel_Superior FROM Datos_Comunes WHERE Tipo=4 and Nivel = 1 and Estado = 1 order by Observacion desc , 2 "
    Set rs=nothing
...
<body class="landing">
    ...
    <div id="page-wrapper">
        ...
        <header id="header" class="alt">
            <h1><a href="index.asp">
                <img src="./images/logo_chico.png" /></a></h1>
            ...
            <section class="box special features">
                    ...
                    <section>
                        <form name="form1_crit" action="#" method="post" class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="slanio" class="form-control text-box-modal" name="anio" style="width: 90%;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <%
											...
											Set rs = cn.Execute(sql)
                                        %>
                                        <select name="equipo" id="equipo" style="margin-bottom: 3px; margin-left: 20px; width: 80%;" class="form-control text-box-modal" onchange="javascript:ValorEquipo()" value="<%=vEquipo%>">
                                            <%
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="txmodelo"></label>
                                        <input type="text" class="form-control text-box-modal" id="txmodelo" name="modelo" placeholder="Modelo" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="txprecio" style="margin-bottom: 3px; margin-left: 46px;"></label>
                                        <input type="text" class="form-control text-box-modal" placeholder="Precio Hasta" id="txprecio" name="precio" style="margin-bottom: 3px; margin-left: 20px; width: 80%;" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label style="margin-bottom: 3px; margin-left: 15px;"></label>
                                        <input type="text" class="form-control text-box-modal" placeholder="dd-mm-aaaa" id="txfecha" name="fecha" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="txprecio" style="margin-bottom: 3px; margin-left: 30px;"></label>
                                        <select size="1" id="familia" name="familia" style="margin-bottom: 3px; margin-left: 20px; width: 80%;" class="form-control text-box-modal" onchange="javascript:sublist(document.forms.form1_crit, familia.value);" value="<%=vRegion%>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="txprecio" style="margin-bottom: 3px; margin-left: 46px;"></label>
                                        <select id="subcatagory" name="subcatagory" onchange="javascript:ValorCiudad()" size="1" value="<%=vCiudad%>" class="form-control text-box-modal" style="width: 90%;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <br />
                                    <button class="btn btn-default" onclick="javascript:irA(document.forms.form1_crit,'resultado_busqueda.asp?opc=sch');" style="display: inline-block; padding: 4px 12px; margin-bottom: 0; font-size: 14px; line-height: 20px; color: #fff; text-align: center; font-weight: 600; vertical-align: middle; cursor: pointer; background-color: #f7931e; background-repeat: repeat-x; border-bottom-color: #f7931e; border-radius: 4px;">Filtrar</button>
                                </div>
                            </div>
                            <br />
                </div>
                ...
                <table id="tabla">
                    <%
									...
									sql=sql & " '" & request.Form("anio") & "', "
									end if
									if request.Form("modelo") = "" then
									sql=sql & " '', "
									else
									sql=sql & " '" & request.Form("modelo") & "', "
									end if
									if request.Form("precio") = "" then
									sql=sql & " '', "
									else
									sql=sql & " '" & request.Form("precio") & "', "
									end if
									...
									if request.Form("subcatagory") = "" or request.Form("subcatagory") = "2366" or request.Form("subcatagory") = "2367" or request.Form("subcatagory") = "2368" or request.Form("subcatagory") = "2369" or request.Form("subcatagory") = "2370" or request.Form("subcatagory") = "2371" or request.Form("subcatagory") = "2372" or request.Form("subcatagory") = "2373" or request.Form("subcatagory") = "2374" or request.Form("subcatagory") = "2375" or request.Form("subcatagory") = "2376" or request.Form("subcatagory") = "2377" or request.Form("subcatagory") = "2378" or request.Form("subcatagory") = "2379" or request.Form("subcatagory") = "2380" then
									sql=sql & " 0 "
									else
                                                ...
                                                if rs("url_img_chica") <> "" then
                                                   set url_img = rs("url_img_chica")
													...
													response.write "<tr><td style=""width:300px;"">" &_    
                                                                        "<a href=""detalle_venta.asp?id=" & rs("id_venta") & """><img width=200 height=200 style=""width:100%;"" src="""& url_img &""" alt=""imagen_maq"" /></a></td>" & _
                                                                        "<td style=""vertical-align:top; text-align:left;"">" & _
                                                                                ...
                                                                                "<p style=""margin-bottom:3px; font-weight:bold; color:#3B5998;"">Modelo: " & rs("vent_equipo_modelo") & " <br/> Marca: " & rs("vent_equipo_marca") & " <br/> A&ntilde;o: " & rs("vent_anio") & "</p>" & _
                                                                                "<p style=""margin-bottom:3px; font-weight:bold; color:#3B5998;"">Precio: $ " & FormatNumber(rs("vent_equipo_precio"),0) & " </p>" & _
																				"<p style=""margin-bottom:3px; font-weight:bold; color:#3B5998;"">Region: " & rs("region") & " </p>" & _
																				"<p style=""margin-bottom:3px; font-weight:bold; color:#3B5998;"">Ciudad: " & rs("ciudad") & " </p>" & _
                        ...
                        <div class="table-responsive">
                            <h5>
                                <p>
                                    ...
                                    <br>
                                    <div align="justify" class="text-box-modal">Mundo Maquinaria SpA se reserva el derecho a modificar la presente política de privacidad y será responsabilidad del usuario la lectura y acatamiento de esta cada vez que ingrese al sitio.</div>
                                    <hr>
                                    <p>
                                        ...
                                        <p>
                                            ...
                                            <p>
                                                ...
                                                <p>
                                                    ...
                                                    <br>
                                                    <div align="justify" class="text-box-modal">Al acceder al sitio, el visitante tendrá derecho a revisar toda la información que esté disponible en él. Sin perjuicio de lo anterior, Mundo Maquinaria no se hace responsable por la veracidad o exactitud de la información que haya sido entregada por terceros.</div>
                                                    <br>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <h5>
                                <br>
                                <div align="justify" class="text-box-modal">Este contrato describe los términos y condiciones generales (en adelante los “TCG”) que se aplican al uso de los servicios (en adelante los “Servicios") ofrecidos por Mundo Maquinaria SpA (en adelante “Mundo Maquinaria”) a través de su sitio web www.mundomaquinaria.cl (en adelante el “Sitio”).</div>
                                <br>
                                <br>
                                <div align="justify" class="text-box-modal">Cualquier persona que desee acceder y/o usar el Sitio o los Servicios podrá hacerlo sujetándose a éstos TCG junto con todas las demás políticas y principios que rigen el Sitio y que son incorporados a los presentes TCG por referencia. </div>
                                <br>
                                <div align="justify" class="text-box-modal">TODA PERSONA QUE SE REGISTRE EN EL SITIO WWW.MUNDOMAQUINARIA.CL EN CALIDAD DE USUARIO DEBERÁ, EN FORMA PREVIA A SU UTILIZACIÓN, ACEPTAR ESTOS TÉRMINOS Y CONDICIONES GENERALES, LOS CUALES TENDRÁN SIEMPRE UN CARÁCTER OBLIGATORIO Y VINCULANTE.</div>
                                <br>
                                <br>
                                <div align="justify" class="text-box-modal">El Usuario debe leer, entender y aceptar todas las condiciones establecidas en los presentes TCG así como en los demás documentos incorporados a los mismos por referencia, previo a su inscripción como Usuario de Mundo Maquinaria. </div>
                                <br>
                                <div align="justify" class="text-box-modal">Mundo Maquinaria podrá realizar modificaciones a los TCG en cualquier momento, debiendo hacer públicos en el Sitio los términos modificados para ponerlos en conocimiento de los Usuarios y dando aviso de ello mediante correo electrónico al que estuviera registrado por parte del Usuario.</div>
                                <br>
                                <br>
                                <div align="justify" class="text-box-modal">Los términos modificados entrarán en vigor en el plazo de 10 (diez) días desde su publicación en el Sitio. Transcurrido ese plazo, el silencio se considerará como aceptación del Usuario y el contrato continuará vinculando a ambas partes. </div>
                                <br>
                                <div align="justify" class="text-box-modal">Si el Usuario no aceptare las modificaciones a los presentes TCG, deberá, en el mismo plazo indicado anteriormente, comunicarlo por escrito al correo electrónico contacto@mundomaquinaria.cl, cesando desde ese momento todos los efectos que emanan de estos TCG y quedando automáticamente inhabilitado como Usuario, siempre y cuando no tenga obligaciones o deudas  pendientes con Mundo Maquinaria, las que deberán solucionarse antes de dar por terminado el vínculo contractual entre las partes.</div>
                                <br>
                                <br>
                                <br>
                                <div align="justify" class="text-box-modal">Los Servicios se prestarán a personas naturales o jurídicas que tengan capacidad legal para contratar. No podrán utilizar los servicios las personas que no tengan esa capacidad, los menores de edad o Usuarios de Mundo Maquinaria que hayan sido suspendidos temporalmente o inhabilitados definitivamente. </div>
                                <br>
                                <br>
                                <div align="justify" class="text-box-modal">En el caso de personas jurídicas, debe tratarse de un representante legal con facultades necesarias y suficientes para contratar a nombre de tal entidad y de obligar a la misma en los términos de estos TCG. Por lo tanto, se considerará que cualquier persona jurídica que utilice los servicios de “Mundo Maquinaria” cumple con lo señalado anteriormente.</div>
                                <br>
                                <hr>
                                <p>
                                    <b>1. CONDICIONES GENERALES Y DEFINICIONES PREVIAS.</b><br>
                                    <div align="justify" class="text-box-modal">1.1 El objetivo de los Servicios es proporcionar un sitio en internet para la búsqueda y oferta de maquinarias, así como servicios y productos afines. El Sitio incluye condiciones de uso y políticas de privacidad que fijan las medidas que Mundo Maquinaria puede tomar para que la información que le facilitan los Usuarios permanezca segura y sea utilizada únicamente para los fines a los que está destinada.</div>
                                    <br>
                                    <br>
                                    <div align="justify" class="text-box-modal">1.2 Mundo Maquinaria no es propietario de los bienes y servicios publicados u ofrecidos a través del Sitio, ni participa de modo alguno en el negocio de arriendo o venta de los mismos y no recibe comisión por las transacciones efectuadas entre los Usuarios. Asimismo, no comercializa los productos y servicios publicados. Su vinculación a estos productos, sus oferentes y las ofertas encontradas en el Sitio, se limita únicamente ser un medio de publicación en internet. La información publicada es de exclusiva responsabilidad de los Usuarios.</div>
                                    <br>
                                    <br>
                                    <br>
                                    <div align="justify" class="text-box-modal">1.3 Niveles de interacción con el Sitio. Existen distintos niveles de vinculación con el Sitio, según las siguientes definiciones: </div>
                                    ...
                                    <br>
                                    <div align="justify" class="text-box-modal">b. Usuario: Es aquel Visitante registrado que hace uso del Sitio para ofrecer el arriendo, la venta de un producto determinado o la prestación de algún servicio.</div>
                                    <hr>
                                    <p>
                                        <b>2. INSCRIPCIÓN DEL USUARIO.</b><br>
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <hr>
                                                                                <p>
                                                                                    <b>13. TARIFAS COBROS POR EL SERVICIO.</b><br>
                                                                                    <div align="justify" class="text-box-modal">La inscripción en Mundo Maquinaria es gratuita. Al publicar bienes o servicios para la venta o arriendo, el Usuario deberá pagar un cargo de publicación, cuyo costo es variable de acuerdo al plan que elija. El precio de dichos planes variará conforme a la cantidad de información que éstos permitan cargar o publicar en el Sitio.</div>
                                                                                    <br>
                                                                                    <br>
                                                                                    <div align="justify" class="text-box-modal">Todo anuncio será activado una vez confirmado el pago por parte de Mundo Maquinaria. El anuncio podrá ser eliminado del Sitio si han transcurrido más de cuarenta y ocho (48) horas desde su ingreso al sistema y no se ha recibido la confirmación del pago.</div>
                                                                                    <br>
    ...
    <footer id="footer">
        ...
        <ul class="copyright" style="font-weight: 100; font-size: small">
            ...
            <li>Diseñado por: <a href="http://gofour.cl" style="background: transparent; font-size: small; padding: 0 0 0 0; border-radius: 0; text-transform: capitalize; font-weight: 100;">Go Four</a></li>
        </ul>
