...
<div id="content-header">
  ...
  <h1>Mantenedor de Planes Mensuales</h1>
</div>
<%if request.QueryString("opc")= "sav" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_men.asp?msg=1";
	</script>
	<%
end if
if request.QueryString("opc")= "sav2" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_men.asp?msg=2";
	</script>
	<%
end if
if request.QueryString("opc")= "del" then 
	...
	<script type="text/javascript">
		...
		window.location="mant_pl_men.asp?msg=3";
	</script>
	<%
end if
%>
<%if request.QueryString("opc")= "idmaq" then 
	...
	<%
		...
		if len(var_chk_sel) > 0 then
				Response.Redirect("mant_pl_men.asp?opc=edit&id="& var_chk_sel)
				Response.End
		end if
	end if
end if
    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon border-blue"> <i class="icon-align-justify"></i> </span>
          <h5>Mantenedor de Planes Mensuales</h5>
        </div>
        <div class="widget-content nopadding">
          <form name="form1_crit" action="#" method="post" class="form-horizontal">
			...
			<div class="form-actions">
              <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'mant_pl_men.asp?opc=sch');">Buscar</button>
			  <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form1_crit,'mant_pl_men.asp?opc=new');">Nuevo</button>
            </div>
			<br>
          </form>
        </div>
   ...
   <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="form-actions">
            <button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form2_crit,'mant_pl_men.asp?opc=idmaq');">Editar</button>
        ...
        <div class="widget-content nopadding">
           <form name="form3_crit" method="post" class="form-horizontal">
			...
			<div>
              ...
              <div class="controls">
                <input type="text" class="span11" name="Desc1" id="Desc1" value="<%=vDesc1%>"/>
				</div><br>
			</div><br>
			<div>
			...
			<div>
              ...
              <div class="controls">
                <input type="text" class="span11" name="Regiones" id="Regiones" value="<%=vRegiones%>"/>(Para todas las regiones ingrese -1)
			</div><br>
			...
			<div>
              ...
              <div class="controls">
                <input type="text" class="span11" name="Equipos" id="Equipos" value="<%=vEquipo%>"/>(Para todas los equipos ingrese -1)
			</div><br>
			...
			<br>
			<div class="form-actions">
				<button type="submit" class="btn btn-success" onClick="javascript:validarDatos(document.forms.form3_crit,'mant_pl_men.asp?opc=sav');">Guardar</button>
				<button type="submit" class="btn btn-success" onClick="javascript:irA(document.forms.form3_crit,'mant_pl_men.asp?opc=del');">Eliminar</button>
			</div><br>
          </form>
        </div>
      </div>
		  ...
		  <div class="widget-box">
			...
			<div class="widget-content nopadding">
			   <form name="form4_crit" method="post" class="form-horizontal">
				...
				<br>
				<div class="form-actions">
					<button type="submit" class="btn btn-success" onClick="javascript:validarDatos(document.forms.form4_crit,'mant_pl_men.asp?opc=sav2');">Guardar</button>
				</div>
			  </form>
			</div>
		  </div>
